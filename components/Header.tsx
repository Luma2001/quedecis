...
const Header = () => {
  return (
      <header id="header" className="fixed top-0 left-0 right-0 bg-slate-900 max-w-full mx-auto px-6 py-5 flex items-center justify-between border-b border-slate-800/40 z-100">
